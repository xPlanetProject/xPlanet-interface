...
const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  [SupportedChainId.MAINNET]: CurrencyAmount.fromRawAmount(USDC as Token, 100_000e6),
}
...
export default function useUSDCPrice(currency?: Currency): Price<Currency, Token> | undefined {
  ...
  // console.log(currency, chainId === ChainId.MAINNET ? usdcCurrencyAmount : undefined)
